...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { filling: @table.filling, list: @table.list, quantity: @table.quantity } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { filling: @table.filling, list: @table.list, quantity: @table.quantity } }
